...
document.querySelector('.btn_1').onclick = function(e) {
  window.location = 'https://rolling-scopes-school.github.io/alesia2503-JSFE2023Q4/coffee-house/';
};
document.querySelector('.btn_4').onclick = function(e) {
  window.location = 'https://fastmotors.by/';
};
document.querySelector('.btn_2').onclick = function(e) {
  window.location = 'https://rolling-scopes-school.github.io/alesia2503-JSFE2023Q4/hangman/';
};
document.querySelector('.btn_3').onclick = function(e) {
  window.location = 'https://rolling-scopes-school.github.io/alesia2503-JSFE2023Q4/nonograms/';
};
